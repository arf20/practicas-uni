...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cout << cache->NAME;
    cout << " DEMAND    ACCESS: " << setw(10) << cache->roi_access[cpu][0] + cache->roi_access[cpu][1] << "  HIT: " << setw(10) << cache->roi_hit[cpu][0] + cache->roi_hit[cpu][1] << "  MISS: " << setw(10) << cache->roi_miss[cpu][0] + cache->roi_miss[cpu][1] << endl;
