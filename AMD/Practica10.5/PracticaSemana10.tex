...
% El estilo para pintar el cuadrado se llama "cara" porque es el que usaremos para pintar las caras de los poliedros en el espacio.
...
\draw[->,very thick] (0,0) -- !{u1}; 
\draw[->,very thick] (0,0) -- !{u2};
\node at !{1.2*u1} {$u_1$};
\node at !{1.2*u2} {$u_2$};
