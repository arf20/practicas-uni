...
tlv = _sage_const_3  * b1

V2 = [(V[i] + tlv) for i in range(_sage_const_6 )]
...
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_0 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_1 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_2 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_3 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_4 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_5 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V[_sage_const_0 ])
print('=>PYTHONTEX:FIELD_DELIM#')
print(V2[_sage_const_0 ])
