...
HI = block_matrix([[H.T, 1]])
HIr = HI.echelon_form()
HIr = copy(HIr)
HIr.subdivide(2, 2)
A = HIr.subdivision(1, 1).T
Av = vector(RR, A.column(0))
\end{sageblock}
...
%\begin{align*}
%	x &= 0 \\
%	\sage{H[0][1]}y \sage{H[0][2]}z &= 0 \\
%	y &= \frac{\sage{-H[0][2]}z}{\sage{H[0][1]}} \\
%	\sage{H[1][1]}y + \sage{H[1][2]}z &= 0 \\
%\end{align*}
...
\begin{align*}
	\vec{b_1} &= \frac{\vec{2_1}}{||\vec{2_1}||} \\
	\vec{b_2} &= \frac{\vec{v_1}}{||\vec{v_1}||} \\
	\vec{b_3} &= \frac{\vec{w_1} \times \vec{v_r}}{||\vec{w_1} \times \vec{v_r}||} \\
\end{align*}
$$
	B = \begin{bmatrix}
...
\draw[->,thick,blue] (0,0,0) -- !{b};

\draw[->,thick,blue] (0,0,0) -- !{Av};
\end{tikzpicture}
\end{sagesub}
\end{center}
